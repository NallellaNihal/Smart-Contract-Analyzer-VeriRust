// VeriRust Analyzer Target File: vault_guard_v70.rs
// Description: DeFi vault guard with pause and withdrawal controls - varied analyzer test case 70
...
pub fn vault_guard_inline_probe(value: u32, guard: u32) -> u32 {
    if value > guard { value.saturating_add(10) } else { guard.saturating_sub(value % 2) }
}
...
pub fn vault_guard_score(amount: u64, limit: u64, signal: u32, epoch: u32, flag: bool) -> i64 {
    let mut score = vault_guard_inline_probe(signal, 40) as i64;
