// VeriRust Analyzer Target File: token_vesting_v93.rs
// Description: Token vesting unlock schedule and cliff checker - varied analyzer test case 93
...
pub fn token_vesting_inline_probe(value: u32, guard: u32) -> u32 {
    if value > guard { value.saturating_add(3) } else { guard.saturating_sub(value % 4) }
}
...
pub fn token_vesting_score(amount: u64, limit: u64, signal: u32, epoch: u32, flag: bool) -> i64 {
    let mut score = token_vesting_inline_probe(signal, 63) as i64;
