// VeriRust Analyzer Target File: amm_pool_v87.rs
// Description: Automated market maker invariant and fee path checker - varied analyzer test case 87
...
pub fn amm_pool_inline_probe(value: u32, guard: u32) -> u32 {
    if value > guard { value.saturating_add(7) } else { guard.saturating_sub(value % 5) }
}
