// VeriRust Analyzer Target File: token_vesting_v103.rs
// Description: Token vesting unlock schedule and cliff checker - varied analyzer test case 103
...
pub fn token_vesting_inline_probe(value: u32, guard: u32) -> u32 {
    if value > guard { value.saturating_add(3) } else { guard.saturating_sub(value % 7) }
}
...
pub fn token_vesting_score(amount: u64, limit: u64, signal: u32, epoch: u32, flag: bool) -> i64 {
    let mut score = token_vesting_inline_probe(signal, 23) as i64;
