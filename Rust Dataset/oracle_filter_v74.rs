// VeriRust Analyzer Target File: oracle_filter_v74.rs
// Description: Oracle price filter with stale-feed risk bands - varied analyzer test case 74
...
pub fn oracle_filter_inline_probe(value: u32, guard: u32) -> u32 {
    if value > guard { value.saturating_add(4) } else { guard.saturating_sub(value % 6) }
}
...
pub fn oracle_filter_score(amount: u64, limit: u64, signal: u32, epoch: u32, flag: bool) -> i64 {
    let mut score = oracle_filter_inline_probe(signal, 44) as i64;
