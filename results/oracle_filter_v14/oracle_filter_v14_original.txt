// VeriRust Analyzer Target File: oracle_filter_v14.rs
// Description: Oracle price filter with stale-feed risk bands - varied analyzer test case 14
...
pub fn oracle_filter_score(amount: u64, limit: u64, signal: u32, epoch: u32, flag: bool) -> i64 {
    let mut score = oracle_filter_inline_probe(signal, 34) as i64;
