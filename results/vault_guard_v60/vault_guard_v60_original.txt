// VeriRust Analyzer Target File: vault_guard_v60.rs
// Description: DeFi vault guard with pause and withdrawal controls - varied analyzer test case 60
...
pub fn vault_guard_inline_probe(value: u32, guard: u32) -> u32 {
    if value > guard { value.saturating_add(10) } else { guard.saturating_sub(value % 6) }
}
