// VeriRust Analyzer Target File: oracle_filter_v44.rs
// Description: Oracle price filter with stale-feed risk bands - varied analyzer test case 44
...
pub fn oracle_filter_inline_probe(value: u32, guard: u32) -> u32 {
    if value > guard { value.saturating_add(4) } else { guard.saturating_sub(value % 4) }
}
