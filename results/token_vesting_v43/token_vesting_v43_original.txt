// VeriRust Analyzer Target File: token_vesting_v43.rs
// Description: Token vesting unlock schedule and cliff checker - varied analyzer test case 43
...
pub fn token_vesting_inline_probe(value: u32, guard: u32) -> u32 {
    if value > guard { value.saturating_add(3) } else { guard.saturating_sub(value % 3) }
}
