// VeriRust Analyzer Target File: risk_router_v91.rs
// Description: Cross-chain liquidity route scoring and slippage guard - varied analyzer test case 91
...
pub fn risk_router_inline_probe(value: u32, guard: u32) -> u32 {
    if value > guard { value.saturating_add(1) } else { guard.saturating_sub(value % 2) }
}
